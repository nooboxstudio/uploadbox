...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "cad-form")) {
  $insertSQL = sprintf("INSERT INTO condominios (id_cond, name_cond) VALUES (%s, %s)",
...
<html>
  <head>
    <title>Novo Condomínio | <?php print $sitename; ?></title>
...
<!--fim do menu-->
		  <div class="col-md-10">
            ...
            <h4>Cadastrar Condomínio:</h4>
				<form action="<?php echo $editFormAction; ?>" method="POST" name="cad-form" id="cad-form">
                <input name="id" type="hidden" id="id">
                <input name="name" class="form-control" type="text" id="name" placeholder="Insira o nome do condominio"><br>
                <input name="cadastrar" type="submit" id="cadastrar" value="Cadastrar" class="btn btn-success" style="float:right"><br>
<br>
<input type="hidden" name="MM_insert" value="cad-form">
