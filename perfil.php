...
$colname_usuario_logado_perfil = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_usuario_logado_perfil = $_SESSION['MM_Username'];
}
mysql_select_db($database_conn, $conn);
$query_usuario_logado_perfil = sprintf("SELECT * FROM `user` WHERE user_name = %s", GetSQLValueString($colname_usuario_logado_perfil, "text"));
$usuario_logado_perfil = mysql_query($query_usuario_logado_perfil, $conn) or die(mysql_error());
$row_usuario_logado_perfil = mysql_fetch_assoc($usuario_logado_perfil);
$totalRows_usuario_logado_perfil = mysql_num_rows($usuario_logado_perfil);
?>
<!DOCTYPE html>
<html>
  <head>
    <title>Perfil | <?php print $sitename; ?></title>
	  			...
	  			<div class="row">
	  				<div class="col-md-8">
	  					<div class="content-box-large">
                            ...
                            <h4>Acessando como:</h4>

                                        <table width="100%" border="0" cellspacing="3" cellpadding="3">
  <tr>
    <td>
    <?php
								$hash = md5( $row_usuario_logado_perfil['user_name'] );
                                ?>
                            <img src="https://www.gravatar.com/avatar/<?php echo $hash; ?>?s=150" title="Para alterar acesse gravatar.com">
    </td>
    <td><div class="form-group">
                                        <h4>Nome: <?php echo $row_usuario_logado_perfil['name']; ?></h4>
										</div>
                                        <div class="form-group">
                                        <h4>E-mail: <?php echo $row_usuario_logado_perfil['user_name']; ?></h4>
										</div></td>
  </tr>
</table>
...
mysql_free_result($usuario_logado_perfil);
?>
